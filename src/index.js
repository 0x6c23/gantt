...
export default class Gantt {
    ...
    setup_gantt_dates() {
        ...
        if (this.view_is([VIEW_MODE.HOUR, VIEW_MODE.QUARTER_DAY, VIEW_MODE.HALF_DAY, VIEW_MODE.DAY])) {
            ...
            this.gantt_end =   date_utils.add(this.options.current_day, 1, 'day'); // this.gantt_end === this.gantt_start ? date_utils.add(this.gantt_end, 1, 'day') : this.gantt_end; // date_utils.add(this.gantt_end, 1, 'day');
