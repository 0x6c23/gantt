...
export default class Gantt {
    ...
    setup_gantt_dates() {
        ...
        if (this.view_is(VIEW_MODE.HOUR)) {
            this.gantt_start = this.gantt_start; //date_utils.add(date_utils.start_of(this.current_day, 'day'), -30, 'minute'); // this.gantt_start; // date_utils.add(this.gantt_start, -1, 'day');
